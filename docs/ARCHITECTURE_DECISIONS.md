...
- [V. Infrastructure & Persistence](#v-infrastructure--persistence)
  * [10. Modular FHIR Models (Granular Imports)](#10-modular-fhir-models-granular-imports)
  * [11. Use fhir.resources Package](#11-use-fhir-resources-package)
  * [12. Use fhir.resources Package (FHIR R5)](#12-use-fhir-resources-package-fhir-r5)
  * [13. Use SQLite for Local Clinic Deployments](#13-use-sqlite-for-local-clinic-deployments)
...
### 10. Modular FHIR Models (Granular Imports)
**Status:** Proposed
...
### 12. Use fhir.resources Package (FHIR R5)
**Status:** Accepted
